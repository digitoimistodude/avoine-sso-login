 ...
 * @Last Modified time: 2022-04-25 14:49:44
 *
...
function login_check_is_sso_user_active( $sso_user = null ) {
   ...
   */
  $active = apply_filters( 'avoine-sso-login\login\user-is-active', true, $sso_user, $sso_user_info );
  ...
  do_action( 'avoine-sso-login\login\user-is-active\after', $sso_user, $sso_user_info );
